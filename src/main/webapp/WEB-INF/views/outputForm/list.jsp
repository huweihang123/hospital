    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#selectgo").change(function () {
                if ($("#keyGo").val() == '') {
                    window.location.href = "/outputForm" +
...
<body>
<form id="searchForm" action="#outputForm" method="post">
    <div id="container">
                ...
                <table class="table table-striped table-border">
                    ...
                    <s:iterator value="#outputForms">
                        <tr>
                            ...
                            <th><a href="/outputForm_findCareful?outformID=<s:property value="id"/>">详细查看</a></th>
                        </tr>
                    </s:iterator>
                    </tbody>
                </table>

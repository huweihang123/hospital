...
<head>
	...
	<script type="text/javascript" src="/js/jquery/systemmanager.js"></script>
</head>
<body>
	<input id="person" value="<s:property value='#systemManager.name'/>"/>
    <div id="top">
		<div id="top_links">
			<div id="top_op">
				<ul>
					...
					<li>
						...
						<span><s:property value="#systemManager.name"/></span>
					</li>
				</ul> 
			</div>
			<div id="top_close">
		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
					<div id="first">
						<button onclick="inPutFormGet()">采购单查询</button>
						<button onclick="outformsGet()">出库单查询</button>
						<button onclick="warehouseshow()">数据库查询</button>
					</div>
					<div id="second">
						<button id="drugs" onclick="indrugs()">进货图表查看</button>
						<button id="supplier" onclick="outdrugs()">出货图表查看</button>
						<button id="inmanager" onclick="inmanager()">采购管理员管理</button>
						<button id="outmanager" onclick="outmanager()">仓储管理员管理</button>
					</div>
						<div id="third">

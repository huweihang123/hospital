...
<head>
	...
	<script type="text/javascript" src="/js/jquery/purchasemanager.js"></script>
</head>
<body>
	<input id="person" value="<s:property value='#purchaseManager.name'/>"/>
    <div id="top">
		<div id="top_links">
			<div id="top_op">
				<ul>
					...
					<li>
						...
						<span><s:property value="#purchaseManager.name"/></span>
					</li>
				</ul> 
			</div>
			<div id="top_close">
				<s:a action="logout" target="_parent">
					<img alt="退进系统" title="退进系统" src="images/common/close.jpg" style="position: relative; top: 10px; left: 25px;">
				</s:a>
			</div>
		</div>
	</div>
		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
					<div id="first">
						<button onclick="formsGet()">进货报表填报</button>
						<button onclick="outPutFormGet()">进货填报查询</button>
						<button onclick="outPutEchartshow()">进货药品图表</button>
					</div>
					<div id="second">
